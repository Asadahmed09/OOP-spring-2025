...
{
  Media *list[3];
  list[0] = new Book("The Alchemist", "1988", "HarperOne", "Paulo Coelho", "978-0062315007", "197");
  list[1] = new CD("Thriller", "1982", "Epic Records", "Michael Jackson", "9", "Pop");
  list[2] = new DVD("Inception", "2010", "Warner Bros.", "Christopher Nolan", "148 minutes", "PG-13");
  SearchMedia(list, 3, "The Alchemist");
  SearchMediaByDate(list, 3, "1982");
  SearchMediaByPublisher(list, 3, "Warner Bros.");
  for (int i = 0; i < 3; i++)
  {
    delete list[i];
  }
